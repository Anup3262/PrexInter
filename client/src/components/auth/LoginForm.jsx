...
function LoginForm() {
  ...
  return (
    ...
    >
      <div className="text-center">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500 to-indigo-600 text-2xl font-black shadow-lg shadow-violet-600/30">
          P
        </div>
      ...
      <form onSubmit={handleSubmit} className="mt-8">
        ...
        <div className="relative mt-2">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-white/10 bg-white/[0.04] py-4 pl-12 pr-4 text-white outline-none transition placeholder:text-slate-600 focus:border-violet-500 focus:bg-white/[0.06] focus:ring-4 focus:ring-violet-500/10"
          />
        </div>
        ...
        <div className="relative mt-2">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-white/10 bg-white/[0.04] py-4 pl-12 pr-12 text-white outline-none transition placeholder:text-slate-600 focus:border-violet-500 focus:bg-white/[0.06] focus:ring-4 focus:ring-violet-500/10"
          />
        ...
        <motion.button
          ...
          className="mt-7 flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 px-5 py-4 font-bold text-white shadow-xl shadow-violet-950/40 transition disabled:cursor-not-allowed disabled:opacity-60"
        >
          {submitting ? (
            <>
  ...
  <SocialButton
    ...
    onClick={() =>
      toast("Phone login will be added later.")
    }
  />
  ...
  <SocialButton
    ...
    onClick={() =>
      toast("Facebook login will be added later.")
    }
  />
</div>
      ...
      <div cclassName="relative z-20 mx-auto w-full max-w-[530px] rounded-[30px] border border-violet-500/60 bg-[#090b16]/95 px-6 py-8 shadow-[0_30px_100px_rgba(76,29,149,0.35)] backdrop-blur-2xl sm:px-10 sm:py-9">
        <ShieldCheck size={15} />
